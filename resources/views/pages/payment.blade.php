						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
                                ...
                                @php
                                    ...
                                    if($customer_id){
                                @endphp
                                    <a href="{{ URL::to('/checklogin') }}"><i class="fa fa-lock"></i> LogOut</a>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<form method="post" action="{{ url('/update_cart') }}">
										{{ csrf_field() }}
									<input class="cart_quantity_input" type="text" name="qty" value="{{ $all_cart_data->qty }}" autocomplete="off" size="2" readonly="">
						...
						<div class="btn-group paymentBtnGroup btn-group-justified" data-toggle="buttons">
				            <label class="btn paymentMethod active">
				            	<div class="method visa">
				            		<img style="height:100%;width:100%;" src="{{ URL::to('frontend/images/payment/paypal-784404_960_720.png') }}" alt="">
				            	</div>
				                <input type="radio" name="payment_method" checked value="paypal"> 
				            </label>
				            <label class="btn paymentMethod">
				            	<div class="method master-card">
				            		<img style="height:100%;width:100%;" src="{{ URL::to('frontend/images/payment/master-card.jpg') }}" alt="">
				            	</div>
				       		...
				       		<label class="btn paymentMethod">
			             		<div class="method vishwa">
			             			<img style="height:100%;width:100%;" src="{{ URL::to('frontend/images/payment/bkash-logo-FBB258B90F-seeklogo.com.png') }}" alt="">
			             		</div>
				                <input type="radio" name="payment_method" value="bkash"> 
				            </label>
				            <label class="btn paymentMethod">
			            		<div class="method ez-cash">
			            			<img style="height:100%;width:100%;" src="{{ URL::to('frontend/images/payment/download.jpg') }}" alt="">
			            		</div>
				                <input type="radio" name="payment_method" value="ssl"> 
				            </label> 
				            <label class="btn paymentMethod">
			            		<div class="method ez-cash">
			            			<img style="height:100%;width:100%;" src="{{ URL::to('frontend/images/payment/wa.jpg') }}" alt="">
			            		</div>
				                <input type="radio" name="payment_method" value="hand_cash"> 
				            </label> 
				         
				        </div>  
				        <input type="submit" class="btn btn-success pull-left btn-fyi" value="Submit"> 
				        </form>     
					</div>
