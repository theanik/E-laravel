			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{ URL::to('/all_cat') }}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Catagory</span></a></li>
						<li><a href="{{ URL::to('/add_cat') }}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Catecory</span></a></li>
						...
						<li><a href="{{ URL::to('/all_slider') }}"><i class="icon-list-alt"></i><span class="hidden-tablet"> All Slider</span></a></li>
